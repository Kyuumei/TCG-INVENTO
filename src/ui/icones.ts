...
export const ICONES = {
  ...
  repos: S('M12 3a9 9 0 1 0 9 9M9 4h5l-5 5h5'),
  evolution: S('M12 20V5m0 0-6 6m6-6 6 6'),
  aide: S('M12 3a9 9 0 1 0 0 18 9 9 0 0 0 0-18Zm0 13v.5M9.6 9.4a2.5 2.5 0 1 1 3.2 2.9c-.5.2-.8.7-.8 1.2v.4'),
